...
// Built-in skill that ships with HyperCode. The model's intuition for what a
// hypercode.json should look like is often wrong, and HyperCode hard-fails on
// invalid config, so users hit cryptic startup errors. Loading this skill
// when the model is asked to touch HyperCode's own config files gives it the
// actual schemas instead of guesses.
const CUSTOMIZE_HYPERCODE_SKILL_NAME = "customize-hypercode"
const CUSTOMIZE_HYPERCODE_SKILL_DESCRIPTION =
...
const CUSTOMIZE_HYPERCODE_SKILL_BODY = SkillPlugin.CustomizeHypercodeContent
  ...
  Effect.gen(function* () {
    ...
    const state = yield* InstanceState.make(
      Effect.fn("Skill.state")(function* () {
        ...
        s.skills[CUSTOMIZE_HYPERCODE_SKILL_NAME] = {
          name: CUSTOMIZE_HYPERCODE_SKILL_NAME,
          description: CUSTOMIZE_HYPERCODE_SKILL_DESCRIPTION,
          location: "<built-in>",
          content: CUSTOMIZE_HYPERCODE_SKILL_BODY,
        }
