...
const desktopStateNames = ["ai.awareliquid.hypercode.dev", "ai.awareliquid.hypercode.beta", "ai.awareliquid.hypercode"]
...
function executableName() {
  return process.platform === "win32" ? "hypercode-cli.exe" : "hypercode-cli"
}
