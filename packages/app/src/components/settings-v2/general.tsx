        ...
        <SettingsRowV2
          ...
          description={
            <>
              ...
              <ExternalLink class="settings-v2-link" href="https://awareliquid.ai">
...
export const SettingsGeneralV2: Component<{
  ...
  const licenseAvailable = createMemo(() => desktop() && Boolean(platform.license))

  const [licenseStatus, { refetch: refetchLicense }] = createResource(
    () => desktop() && Boolean(platform.license),
      ...
      <div class="settings-v2-section">
        ...
        <SettingsListV2>
          <SettingsRowV2 title={licenseTitle()} description={licenseDetail()}>
            <div class="flex flex-wrap items-center justify-end gap-2">
              <ButtonV2
                size="small"
                variant="neutral"
                onClick={() => platform.openExternal(LICENSE_PURCHASE_URL)}
              >
          ...
          <Show when={licenseStatus()?.decision.mode !== "licensed"}>
            <SettingsRowV2
              title={language.t("settings.license.activate.label")}
              description=""
            >
