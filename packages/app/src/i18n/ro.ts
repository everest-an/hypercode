export const dict = {
  ...
  "desktop.menu.documentation": "Documentație HyperCode",
  ...
  "desktop.menu.ariaLabel": "Meniu HyperCode",
  ...
  "desktop.recovery.loadFailed": "HyperCode nu a putut fi încărcat",
  "desktop.recovery.terminated": "Fereastra HyperCode s-a închis neașteptat",
  "desktop.recovery.unresponsive": "HyperCode nu răspunde",
  ...
  "desktop.wsl.error.installOpencode": "Instalarea HyperCode a eșuat",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "HyperCode nu este instalat în {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Actualizarea HyperCode s-a terminat, dar {{distro}} raportează tot {{installed}}; era așteptat {{expected}}",
  ...
  "dialog.provider.deepseek.note": "Modele selectate, inclusiv Claude, GPT, Gemini și altele",
  "dialog.provider.deepseek.tagline": "Modele optimizate, fiabile",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele gratuite oferite de HyperCode",
  ...
  "provider.connect.apiKey.description":
    "Introdu cheia API {{provider}} pentru a-ți conecta contul și a folosi modelele {{provider}} în HyperCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pentru a obține codul de autorizare și a-ți conecta contul ca să folosești modelele {{provider}} în HyperCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " și introdu codul de mai jos pentru a-ți conecta contul și a folosi modelele {{provider}} în HyperCode.",
  ...
  "dialog.server.description": "Schimbă serverul HyperCode la care se conectează aplicația.",
  ...
  "wsl.onboarding.checkingOpencode": "Se verifică HyperCode...",
  "wsl.onboarding.checkingOpencodeIn": "Se verifică HyperCode în {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Se actualizează HyperCode...",
  "wsl.onboarding.updatingOpencodeIn": "Se actualizează HyperCode în {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualizează HyperCode în {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizează HyperCode",
  "wsl.onboarding.opencodeReadyIn": "HyperCode este gata în {{distro}}.",
  "wsl.onboarding.opencodeReady": "HyperCode este gata.",
  "wsl.onboarding.installOpencodeIn": "Instalează HyperCode în {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalează HyperCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "HyperCode nu este instalat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Subsistemul Windows pentru Linux) este necesar înainte ca HyperCode să poată adăuga un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponibil",
  "wsl.onboarding.wslUnavailable.description": "HyperCode nu a putut verifica WSL pe acest calculator.",
  "wsl.onboarding.installWsl": "Instalează WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Repornește Windows pentru a finaliza instalarea WSL, apoi redeschide HyperCode.",
  ...
  "help.tabs.introduction": "HyperCode Desktop este acum construit în jurul filelor.",
  "help.tabs.sessions":
...
"help.guide.step3.body": "Open a project menu and choose Open Vault — browse the file tree, preview notes and explore the graph view.",
  ...
  "toast.update.description": "O nouă versiune HyperCode ({{version}}) este disponibilă pentru instalare.",
  ...
  "error.page.report.prefix": "Te rugăm să raportezi această eroare echipei HyperCode",
  ...
  "error.chain.mcpFailed": 'Serverul MCP "{{name}}" a eșuat. Atenție, HyperCode nu suportă încă autentificarea MCP.',
  ...
  "sidebar.gettingStarted.line1": "HyperCode include modele gratuite ca să poți începe imediat.",
  ...
  "settings.desktop.wsl.description": "Rulează serverul HyperCode în WSL pe Windows.",
  ...
  "settings.general.row.language.description": "Schimbă limba de afișare pentru HyperCode",
  ...
  "settings.general.row.appearance.description": "Personalizează aspectul HyperCode pe dispozitivul tău",
  "settings.general.row.colorScheme.title": "Scheamă de culori",
  "settings.general.row.colorScheme.description": "Alege dacă HyperCode urmează sistemul, tema deschisă sau închisă",
  "settings.general.row.theme.title": "Temă",
  "settings.general.row.theme.description": "Personalizează tema HyperCode.",
  ...
  "settings.updates.row.startup.description": "Verifică automat actualizările la lansarea HyperCode",
  ...
  "settings.updates.toast.latest.description": "Folosești cea mai recentă versiune HyperCode.",
