...
export const dict = {
  ...
  "dialog.provider.deepseek.note": "Built-in DeepSeek models, one key for all agents",
  "dialog.provider.deepseek.tagline": "Default provider, low cost and reliable",
  ...
  "provider.connect.opencodeZen.line1":
    "HyperCode gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "dialog.plugins.empty": "Plugins configured in hypercode.json",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "HyperCode not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before HyperCode can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "HyperCode could not verify WSL on this machine.",
  ...
  "help.tabs.introduction": "HyperCode Desktop is now built around tabs.",
  "help.tabs.sessions":
...
"help.guide.step3.body": "Open a project menu and choose Open Vault — browse the file tree, preview notes and explore the graph view.",
  ...
  "error.chain.checkConfig": "Check your config (hypercode.json) provider/model names",
  ...
  "settings.license.status.unreachable": "License check unavailable — using trial",
  "settings.license.status.unconfigured": "License service not configured — using trial",
