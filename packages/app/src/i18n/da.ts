export const dict = {
  ...
  "dialog.provider.deepseek.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.deepseek.tagline": "Pålidelige optimerede modeller",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af HyperCode",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i HyperCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "HyperCode giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i HyperCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i HyperCode.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i hypercode.json",
  ...
  "dialog.server.description": "Skift hvilken HyperCode-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker HyperCode...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker HyperCode i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer HyperCode...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer HyperCode i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater HyperCode i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater HyperCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "HyperCode er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før HyperCode kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "HyperCode kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter HyperCode igen.",
  ...
  "toast.update.description": "En ny version af HyperCode ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til HyperCode-teamet",
  ...
  "error.chain.checkConfig": "Kontrollér udbyder- og modelnavnene i din konfiguration (hypercode.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, HyperCode understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "HyperCode inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør HyperCode-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for HyperCode",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan HyperCode ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om HyperCode skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas HyperCodes tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når HyperCode starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af HyperCode.",
  ...
  "desktop.recovery.loadFailed": "HyperCode kunne ikke indlæses",
  "desktop.recovery.terminated": "HyperCode-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installOpencode": "Installationen af HyperCode mislykkedes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "HyperCode er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af HyperCode er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "HyperCode Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
