export const dict = {
  ...
  "desktop.menu.documentation": "HyperCode Documentació",
  ...
  "desktop.menu.ariaLabel": "menú HyperCode.",
  ...
  "desktop.recovery.loadFailed": "HyperCode no s'ha pogut carregar",
  "desktop.recovery.terminated": "La finestra HyperCode s'ha acabat inesperadament",
  "desktop.recovery.unresponsive": "HyperCode no respon",
  ...
  "desktop.wsl.error.installOpencode": "La instal·lació de HyperCode ha fallat",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "HyperCode no està instal·lat a {{distro}}",
  "desktop.wsl.error.updateVersion":
    "HyperCode actualització acabada però {{distro}} encara informa {{installed}}; esperat {{expected}}",
  ...
  "dialog.provider.deepseek.note": "Models seleccionats que inclouen Claude, GPT, Gemini i més",
  "dialog.provider.deepseek.tagline": "Models optimitzats fiables",
  ...
  "dialog.model.unpaid.freeModels.title": "Models gratuïts proporcionats per HyperCode",
  ...
  "provider.connect.apiKey.description":
    "Introduïu la clau API de {{provider}} per connectar el compte i utilitzar els models de {{provider}} a HyperCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per recollir el vostre codi d'autorització per connectar el vostre compte i utilitzar {{provider}} models a HyperCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i introduïu el codi següent per connectar el vostre compte i utilitzar {{provider}} models a HyperCode.",
  ...
  "dialog.server.description": "Canvia a quin HyperCode servidor es connecta aquesta aplicació.",
  ...
  "wsl.onboarding.checkingOpencode": "S'està comprovant HyperCode...",
  "wsl.onboarding.checkingOpencodeIn": "S'està registrant HyperCode a {{distro}}...",
  "wsl.onboarding.updatingOpencode": "S'està actualitzant HyperCode...",
  "wsl.onboarding.updatingOpencodeIn": "S'està actualitzant HyperCode a {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualitza HyperCode a {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualització HyperCode",
  "wsl.onboarding.opencodeReadyIn": "HyperCode està llest a {{distro}}.",
  "wsl.onboarding.opencodeReady": "HyperCode està llest.",
  "wsl.onboarding.installOpencodeIn": "Instal·leu HyperCode a {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal·la HyperCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "HyperCode no instal·lat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsistema per a Linux) és necessari abans que HyperCode pugui afegir un WSL servidor",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "HyperCode no ha pogut verificar WSL en aquesta màquina.",
  "wsl.onboarding.installWsl": "Instal·la WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicieu Windows per acabar d'instal·lar WSL i, a continuació, torneu a obrir HyperCode.",
  ...
  "help.tabs.introduction": "HyperCode L'escriptori ara està construït al voltant de pestanyes.",
  "help.tabs.sessions":
...
"help.guide.step3.body": "Open a project menu and choose Open Vault — browse the file tree, preview notes and explore the graph view.",
  ...
  "toast.update.description": "Una nova versió de HyperCode ({{version}}) ja està disponible per instal·lar-la.",
  ...
  "error.page.report.prefix": "Informeu aquest error a l'equip HyperCode.",
  ...
  "error.chain.mcpFailed":
    'El servidor MCP "{{name}}" ha fallat. Tingueu en compte que HyperCode encara no admet l\'autenticació MCP.',
  ...
  "sidebar.gettingStarted.line1": "HyperCode inclou models gratuïts perquè pugueu començar immediatament.",
  ...
  "app.name.desktop": "HyperCode Escriptori",
  ...
  "settings.desktop.wsl.description": "Executeu el servidor HyperCode dins de WSL a Windows.",
  ...
  "settings.general.row.language.description": "Canvia l'idioma de visualització per a HyperCode",
  ...
  "settings.general.row.appearance.description": "Personalitza com es veu HyperCode al teu dispositiu",
  "settings.general.row.colorScheme.title": "Esquema de colors",
  "settings.general.row.colorScheme.description": "Trieu si HyperCode segueix el tema del sistema, clar o fosc",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalitza la temàtica de HyperCode.",
  ...
  "settings.updates.row.startup.description":
    "Comprova automàticament si hi ha actualitzacions quan s'iniciï HyperCode.",
  ...
  "settings.updates.toast.latest.description": "Esteu executant la darrera versió de HyperCode.",
