export const dict = {
  ...
  "desktop.recovery.loadFailed": "HyperCode gagal dimuat",
  "desktop.recovery.terminated": "Jendela HyperCode berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "HyperCode tidak merespons",
  ...
  "desktop.wsl.error.installOpencode": "Instalasi HyperCode gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "HyperCode belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan HyperCode selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.provider.deepseek.note": "Model pilihan, termasuk Claude, GPT, Gemini, dan lainnya",
  "dialog.provider.deepseek.tagline": "Model andal yang dioptimalkan",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh HyperCode",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di HyperCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di HyperCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di HyperCode.",
  ...
  "dialog.server.description": "Ganti server HyperCode mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Memeriksa HyperCode...",
  "wsl.onboarding.checkingOpencodeIn": "Memeriksa HyperCode di {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Memperbarui HyperCode...",
  "wsl.onboarding.updatingOpencodeIn": "Memperbarui HyperCode di {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Perbarui HyperCode di {{distro}}.",
  "wsl.onboarding.updateOpencode": "Perbarui HyperCode",
  "wsl.onboarding.opencodeReadyIn": "HyperCode siap di {{distro}}.",
  "wsl.onboarding.opencodeReady": "HyperCode siap.",
  "wsl.onboarding.installOpencodeIn": "Instal HyperCode di {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal HyperCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "HyperCode belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum HyperCode dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "HyperCode tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali HyperCode.",
  ...
  "help.tabs.introduction": "HyperCode Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
...
"help.guide.step3.body": "Open a project menu and choose Open Vault — browse the file tree, preview notes and explore the graph view.",
  ...
  "toast.update.description": "Versi baru HyperCode ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim HyperCode",
  ...
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: HyperCode belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "HyperCode menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server HyperCode di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk HyperCode",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan HyperCode di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah HyperCode mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat HyperCode diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru HyperCode.",
