...
const desktop = [
  ...
  "Kilépés",
  "Az HyperCode betöltése sikertelen",
  "Az HyperCode ablaka váratlanul leállt",
  "Az HyperCode nem válaszol",
  ...
  "Az HyperCode telepítése sikertelen",
  ...
  "Az HyperCode nincs telepítve ebben: {{distro}}",
  "Az HyperCode frissítése befejeződött, de a(z) {{distro}} továbbra is ezt jelenti: {{installed}}; a várt érték: {{expected}}",
  "nincs verzió",
...
export const dict = {
  ...
  "dialog.provider.deepseek.note": "Összeválogatott modellek, köztük Claude, GPT, Gemini és még sok más",
  "dialog.provider.deepseek.tagline": "Megbízható optimalizált modellek",
  ...
  "dialog.model.unpaid.freeModels.title": "A HyperCode ingyenes modelljei",
  ...
  "provider.connect.apiKey.description":
    "Enter az Ön {{provider}} API kulcsa fiókja összekapcsolásához és a {{provider}} modellek használatához a HyperCode-ben.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "az engedélyezési kód összegyűjtéséhez fiókja összekapcsolásához és a {{provider}} modellek használatához a HyperCode-ben.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "és írja be az alábbi kódot fiókja összekapcsolásához, és használja a {{provider}} modelleket a HyperCode-ben.",
  ...
  "dialog.server.description": "Állítsa be, hogy ez az alkalmazás melyik HyperCode szerverhez csatlakozzon.",
  ...
  "wsl.onboarding.checkingOpencode": "HyperCode ellenőrzése...",
  "wsl.onboarding.checkingOpencodeIn": "HyperCode ellenőrzése a {{distro}}-ben...",
  "wsl.onboarding.updatingOpencode": "HyperCode frissítése...",
  "wsl.onboarding.updatingOpencodeIn": "HyperCode frissítése a {{distro}}-ben...",
  "wsl.onboarding.updateOpencodeIn": "Frissítse a HyperCode-t a {{distro}}-ben.",
  "wsl.onboarding.updateOpencode": "Frissítse a HyperCode-t",
  "wsl.onboarding.opencodeReadyIn": "A HyperCode készen áll a {{distro}}-ben.",
  "wsl.onboarding.opencodeReady": "A HyperCode készen áll.",
  "wsl.onboarding.installOpencodeIn": "Telepítse a HyperCode-t a {{distro}}-be.",
  "wsl.onboarding.installOpencode": "Telepítse a HyperCode-t",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "A HyperCode nincs telepítve",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "A WSL (Windows alrendszer a Linux számára) szükséges ahhoz, hogy a HyperCode hozzáadhasson egy WSL szervert",
  "wsl.onboarding.wslUnavailable.title": "A WSL nem elérhető",
  "wsl.onboarding.wslUnavailable.description": "A HyperCode nem tudta ellenőrizni a WSL jelet ezen a gépen.",
  "wsl.onboarding.installWsl": "Telepítse a WSL-t",
  "wsl.onboarding.windowsRestartRequired":
    "Indítsa újra a Windows programot a WSL telepítésének befejezéséhez, majd nyissa meg újra a HyperCode programot.",
  ...
  "help.tabs.introduction": "A HyperCode Desktop mostantól lapokra épül.",
  "help.tabs.sessions":
...
"help.guide.step3.body": "Open a project menu and choose Open Vault — browse the file tree, preview notes and explore the graph view.",
  ...
  "toast.update.description": "A HyperCode ({{version}}) új verziója már telepíthető.",
  ...
  "error.page.report.prefix": "Kérjük, jelentse ezt a hibát a HyperCode csapatának",
  ...
  "error.chain.mcpFailed":
    'A "{{name}}" MCP szerver meghibásodott. Megjegyzés: a HyperCode még nem támogatja a MCP hitelesítést.',
  ...
  "sidebar.gettingStarted.line1": "A HyperCode ingyenes modelleket tartalmaz, így azonnal elkezdheti.",
  ...
  "app.name.desktop": "HyperCode asztali számítógép",
  ...
  "settings.desktop.wsl.description": "Futtassa a HyperCode szervert a WSL belsejében a Windows rendszeren.",
  ...
  "settings.general.row.language.description": "Módosítsa a HyperCode kijelző nyelvét",
  ...
  "settings.general.row.appearance.description": "Szabja személyre, hogyan néz ki a HyperCode az eszközén",
  "settings.general.row.colorScheme.title": "Színséma",
  "settings.general.row.colorScheme.description":
    "Válassza ki, hogy a HyperCode a rendszer, a világos vagy a sötét témát követi-e",
  "settings.general.row.theme.title": "Téma",
  "settings.general.row.theme.description": "Szabja személyre a HyperCode témáját.",
  ...
  "settings.updates.row.startup.description": "A HyperCode indításakor automatikusan ellenőrizze a frissítéseket",
  ...
  "settings.updates.toast.latest.description": "Ön a HyperCode legújabb verzióját futtatja.",
