...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "HyperCode yüklenemedi",
  "desktop.recovery.terminated": "HyperCode penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "HyperCode yanıt vermiyor",
  ...
  "desktop.wsl.error.installOpencode": "HyperCode kurulamadı",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "HyperCode, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "HyperCode güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.provider.deepseek.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.deepseek.tagline": "Güvenilir, optimize edilmiş modeller",
  ...
  "dialog.model.unpaid.freeModels.title": "HyperCode tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve HyperCode'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.opencodeZen.line1":
    "HyperCode, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak HyperCode'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak HyperCode'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler hypercode.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi HyperCode sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "HyperCode kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde HyperCode kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "HyperCode güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde HyperCode güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki HyperCode'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "HyperCode'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde HyperCode hazır.",
  "wsl.onboarding.opencodeReady": "HyperCode hazır.",
  "wsl.onboarding.installOpencodeIn": "HyperCode'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "HyperCode'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "HyperCode kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "HyperCode'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "HyperCode bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından HyperCode'u tekrar açın.",
  ...
  "help.tabs.introduction": "HyperCode Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
...
"help.guide.step3.body": "Open a project menu and choose Open Vault — browse the file tree, preview notes and explore the graph view.",
  ...
  "toast.update.description": "HyperCode'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı HyperCode ekibine",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızdaki (hypercode.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: HyperCode henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "HyperCode ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "HyperCode Masaüstü",
  ...
  "settings.desktop.wsl.description": "HyperCode sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "HyperCode'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "HyperCode'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "HyperCode'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "HyperCode'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "HyperCode başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "HyperCode'un en son sürümünü kullanıyorsunuz.",
