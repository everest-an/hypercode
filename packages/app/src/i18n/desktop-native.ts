...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "HyperCode failed to load",
  "desktop.recovery.terminated": "HyperCode window terminated unexpectedly",
  "desktop.recovery.unresponsive": "HyperCode is not responding",
  ...
  "desktop.wsl.error.installOpencode": "HyperCode installation failed",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "HyperCode is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "HyperCode update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
