export const dict = {
  ...
  "desktop.recovery.loadFailed": "HyperCode kunde inte läsas in",
  "desktop.recovery.terminated": "HyperCode-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "HyperCode svarar inte",
  ...
  "desktop.wsl.error.installOpencode": "Installationen av HyperCode misslyckades",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "HyperCode är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "HyperCode-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.provider.deepseek.note": "Kurerade modeller inklusive Claude, GPT, Gemini och mer",
  "dialog.provider.deepseek.tagline": "Pålitliga optimerade modeller",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av HyperCode",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i HyperCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i HyperCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i HyperCode.",
  ...
  "dialog.server.description": "Växla vilken HyperCode-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrollerar HyperCode...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrollerar HyperCode i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppdaterar HyperCode...",
  "wsl.onboarding.updatingOpencodeIn": "Uppdaterar HyperCode i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppdatera HyperCode i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppdatera HyperCode",
  "wsl.onboarding.opencodeReadyIn": "HyperCode är redo i {{distro}}.",
  "wsl.onboarding.opencodeReady": "HyperCode är redo.",
  "wsl.onboarding.installOpencodeIn": "Installera HyperCode i {{distro}}.",
  "wsl.onboarding.installOpencode": "Installera HyperCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "HyperCode är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan HyperCode kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "HyperCode kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan HyperCode igen.",
  ...
  "help.tabs.introduction": "HyperCode Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
...
"help.guide.step3.body": "Open a project menu and choose Open Vault — browse the file tree, preview notes and explore the graph view.",
  ...
  "toast.update.description": "En ny version av HyperCode ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till HyperCode-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, HyperCode stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "HyperCode innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör HyperCode-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för HyperCode",
  ...
  "settings.general.row.appearance.description": "Anpassa hur HyperCode ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om HyperCode följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa HyperCodes tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när HyperCode startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av HyperCode.",
