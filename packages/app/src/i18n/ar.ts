export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل HyperCode",
  "desktop.recovery.terminated": "توقفت نافذة HyperCode بشكل غير متوقع",
  "desktop.recovery.unresponsive": "HyperCode لا يستجيب",
  ...
  "desktop.wsl.error.installOpencode": "فشل تثبيت HyperCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "HyperCode غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث HyperCode، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.provider.deepseek.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.deepseek.tagline": "نماذج موثوقة ومحسنة",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من HyperCode",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في HyperCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "يمنحك HyperCode الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في HyperCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في HyperCode.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في hypercode.json",
  ...
  "dialog.server.description": "تبديل خادم HyperCode الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من HyperCode...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من HyperCode في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث HyperCode...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث HyperCode في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث HyperCode في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث HyperCode",
  "wsl.onboarding.opencodeReadyIn": "HyperCode جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "HyperCode جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت HyperCode في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت HyperCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "HyperCode غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن HyperCode من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على HyperCode التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح HyperCode.",
  ...
  "help.tabs.introduction": "أصبح HyperCode Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
...
"help.guide.step3.body": "Open a project menu and choose Open Vault — browse the file tree, preview notes and explore the graph view.",
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من HyperCode ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق HyperCode",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (hypercode.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن HyperCode لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن HyperCode نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم HyperCode داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ HyperCode",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور HyperCode على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان HyperCode يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة HyperCode.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل HyperCode",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من HyperCode.",
