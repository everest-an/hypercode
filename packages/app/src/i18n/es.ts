export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de HyperCode",
  ...
  "desktop.menu.ariaLabel": "Menú de HyperCode",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar HyperCode",
  "desktop.recovery.terminated": "La ventana de HyperCode se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "HyperCode no responde",
  ...
  "desktop.wsl.error.installOpencode": "No se pudo instalar HyperCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "HyperCode no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de HyperCode finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.provider.deepseek.note": "Selección de modelos como Claude, GPT, Gemini y otros",
  "dialog.provider.deepseek.tagline": "Modelos optimizados y fiables",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por HyperCode",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en HyperCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "HyperCode te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en HyperCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en HyperCode.",
  ...
  "dialog.plugins.empty": "Plugins configurados en hypercode.json",
  ...
  "dialog.server.description": "Cambiar el servidor de HyperCode al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando HyperCode...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando HyperCode en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando HyperCode...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando HyperCode en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza HyperCode en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar HyperCode",
  "wsl.onboarding.opencodeReadyIn": "HyperCode está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "HyperCode está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala HyperCode en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar HyperCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "HyperCode no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que HyperCode pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "HyperCode no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir HyperCode.",
  ...
  "help.tabs.introduction": "HyperCode Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
...
"help.guide.step3.body": "Open a project menu and choose Open Vault — browse the file tree, preview notes and explore the graph view.",
  ...
  "toast.update.description": "Una nueva versión de HyperCode ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de HyperCode",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (hypercode.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: HyperCode aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "HyperCode incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor HyperCode dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para HyperCode",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve HyperCode en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si HyperCode sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de HyperCode.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia HyperCode",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de HyperCode.",
