export const dict = {
  ...
  "desktop.menu.documentation": "HyperCode-documentatie",
  ...
  "desktop.recovery.loadFailed": "HyperCode kan niet worden geladen",
  "desktop.recovery.terminated": "Het HyperCode-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "HyperCode reageert niet",
  ...
  "desktop.wsl.error.installOpencode": "Installatie van HyperCode is mislukt",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "HyperCode is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De HyperCode-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.provider.deepseek.note": "Samengestelde modellen, waaronder Claude, GPT, Gemini en meer",
  "dialog.provider.deepseek.tagline": "Betrouwbare geoptimaliseerde modellen",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door HyperCode",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in HyperCode te gebruiken.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in HyperCode te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in HyperCode te gebruiken.",
  ...
  "dialog.server.description": "Wijzig met welke HyperCode-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingOpencode": "HyperCode controleren...",
  "wsl.onboarding.checkingOpencodeIn": "HyperCode controleren in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "HyperCode bijwerken...",
  "wsl.onboarding.updatingOpencodeIn": "HyperCode bijwerken in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Werk HyperCode bij in {{distro}}.",
  "wsl.onboarding.updateOpencode": "HyperCode bijwerken",
  "wsl.onboarding.opencodeReadyIn": "HyperCode is gereed in {{distro}}.",
  "wsl.onboarding.opencodeReady": "HyperCode is klaar.",
  "wsl.onboarding.installOpencodeIn": "Installeer HyperCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installeer HyperCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "HyperCode niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat HyperCode een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "HyperCode kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens HyperCode opnieuw.",
  ...
  "help.tabs.introduction": "HyperCode Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
...
"help.guide.step3.body": "Open a project menu and choose Open Vault — browse the file tree, preview notes and explore the graph view.",
  ...
  "toast.update.description": "Er is nu een nieuwe versie van HyperCode ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het HyperCode-team",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: HyperCode ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "HyperCode bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de HyperCode-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor HyperCode",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe HyperCode eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of HyperCode het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van HyperCode aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer HyperCode wordt gestart",
  ...
  "settings.updates.toast.latest.title": "HyperCode is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van HyperCode.",
