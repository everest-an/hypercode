...
const desktop = [
  ...
  "Bíða áfram",
  "Hætta",
  "Ekki tókst að hlaða HyperCode",
  "HyperCode-glugganum var óvænt lokað",
  "HyperCode svarar ekki",
  ...
  "HyperCode er ekki uppsett í {{distro}}",
  "Uppfærslu HyperCode lauk en {{distro}} tilkynnir enn {{installed}}; vænt var {{expected}}",
  "engin útgáfa",
...
export const dict = {
  ...
  "dialog.provider.deepseek.note": "Sýndar gerðir þar á meðal Claude, GPT, Gemini og fleira",
  "dialog.provider.deepseek.tagline": "Áreiðanleg bjartsýni módel",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis gerðir frá HyperCode",
  ...
  "provider.connect.apiKey.description":
    "Sláðu inn API-lykilinn þinn fyrir {{provider}} til að tengja reikninginn og nota líkön frá {{provider}} í HyperCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "til að safna heimildarkóðanum þínum til að tengja reikninginn þinn og nota {{provider}} gerðir í HyperCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "og sláðu inn kóðann hér að neðan til að tengja reikninginn þinn og nota {{provider}} gerðir í HyperCode.",
  ...
  "dialog.server.description": "Skiptu um hvaða HyperCode miðlara þetta app tengist.",
  ...
  "wsl.onboarding.checkingOpencode": "Athugar HyperCode...",
  "wsl.onboarding.checkingOpencodeIn": "Athugar HyperCode í {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppfærir HyperCode...",
  "wsl.onboarding.updatingOpencodeIn": "Uppfærir HyperCode í {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppfærðu HyperCode í {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppfærðu HyperCode",
  "wsl.onboarding.opencodeReadyIn": "HyperCode er tilbúið í {{distro}}.",
  "wsl.onboarding.opencodeReady": "HyperCode er tilbúinn.",
  "wsl.onboarding.installOpencodeIn": "Settu upp HyperCode í {{distro}}.",
  "wsl.onboarding.installOpencode": "Settu upp HyperCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "HyperCode ekki uppsett",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows undirkerfi fyrir Linux) þarf áður en HyperCode getur bætt við WSL netþjóni",
  "wsl.onboarding.wslUnavailable.title": "WSL ekki í boði",
  "wsl.onboarding.wslUnavailable.description": "HyperCode gat ekki staðfest WSL á þessari vél.",
  "wsl.onboarding.installWsl": "Settu upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurræstu Windows til að klára að setja upp WSL, opnaðu síðan HyperCode aftur.",
  ...
  "help.tabs.introduction": "HyperCode Desktop er nú byggt í kringum flipa.",
  "help.tabs.sessions":
...
"help.guide.step3.body": "Open a project menu and choose Open Vault — browse the file tree, preview notes and explore the graph view.",
  ...
  "toast.update.description": "Ný útgáfa af HyperCode ({{version}}) er nú fáanleg til uppsetningar.",
  ...
  "error.page.report.prefix": "Vinsamlegast tilkynnið þessa villu til HyperCode teymisins",
  ...
  "error.chain.mcpFailed": "MCP þjónn „{{name}}“ mistókst. Athugið, HyperCode styður ekki MCP auðkenningu ennþá.",
  ...
  "sidebar.gettingStarted.line1": "HyperCode inniheldur ókeypis gerðir svo þú getir byrjað strax.",
  ...
  "app.name.desktop": "HyperCode skjáborð",
  ...
  "settings.desktop.wsl.description": "Keyrðu HyperCode netþjóninn inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Breyttu skjátungumálinu fyrir HyperCode",
  ...
  "settings.general.row.appearance.description": "Sérsníddu hvernig HyperCode lítur út á tækinu þínu",
  "settings.general.row.colorScheme.title": "Litasamsetning",
  "settings.general.row.colorScheme.description": "Veldu hvort HyperCode fylgir kerfis-, ljósu eða dökku þema",
  "settings.general.row.theme.title": "Þema",
  "settings.general.row.theme.description": "Sérsníddu hvernig HyperCode er þema.",
  ...
  "settings.updates.row.startup.description": "Athugaðu sjálfkrafa fyrir uppfærslur þegar HyperCode ræsir",
  ...
  "settings.updates.toast.latest.description": "Þú ert að keyra nýjustu útgáfuna af HyperCode.",
