export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu HyperCode",
  ...
  "desktop.recovery.loadFailed": "Không tải được HyperCode",
  "desktop.recovery.terminated": "Cửa sổ HyperCode đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "HyperCode không phản hồi",
  ...
  "desktop.wsl.error.installOpencode": "Không cài đặt được HyperCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "HyperCode chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật HyperCode nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "dialog.provider.deepseek.note": "Các mô hình được tuyển chọn, gồm Claude, GPT, Gemini và nhiều mô hình khác",
  "dialog.provider.deepseek.tagline": "Các mô hình tối ưu hóa đáng tin cậy",
  ...
  "dialog.model.unpaid.freeModels.title": "Các mô hình miễn phí do HyperCode cung cấp",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong HyperCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong HyperCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong HyperCode.",
  ...
  "dialog.server.description": "Chuyển máy chủ HyperCode mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingOpencode": "Đang kiểm tra HyperCode...",
  "wsl.onboarding.checkingOpencodeIn": "Đang kiểm tra HyperCode trong {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Đang cập nhật HyperCode...",
  "wsl.onboarding.updatingOpencodeIn": "Đang cập nhật HyperCode trong {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Cập nhật HyperCode trong {{distro}}.",
  "wsl.onboarding.updateOpencode": "Cập nhật HyperCode",
  "wsl.onboarding.opencodeReadyIn": "HyperCode đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.opencodeReady": "HyperCode đã sẵn sàng.",
  "wsl.onboarding.installOpencodeIn": "Cài đặt HyperCode trong {{distro}}.",
  "wsl.onboarding.installOpencode": "Cài đặt HyperCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "HyperCode chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi HyperCode có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "HyperCode không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại HyperCode.",
  ...
  "help.tabs.introduction": "HyperCode Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
...
"help.guide.step3.body": "Open a project menu and choose Open Vault — browse the file tree, preview notes and explore the graph view.",
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của HyperCode ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm HyperCode",
  ...
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: HyperCode chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "HyperCode bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ HyperCode bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho HyperCode",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của HyperCode trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem HyperCode tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của HyperCode.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi HyperCode khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của HyperCode.",
