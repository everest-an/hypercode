export const dict = {
  ...
  "desktop.recovery.loadFailed": "HyperCodeを読み込めませんでした",
  "desktop.recovery.terminated": "HyperCodeのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "HyperCodeが応答していません",
  ...
  "desktop.wsl.error.installOpencode": "HyperCodeのインストールに失敗しました",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}}にはHyperCodeがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "HyperCodeのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "dialog.provider.deepseek.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.deepseek.tagline": "信頼性の高い最適化モデル",
  ...
  "dialog.model.unpaid.freeModels.title": "HyperCodeが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、HyperCodeで{{provider}}モデルを使用します。",
  ...
  "provider.connect.opencodeZen.line1":
    "HyperCodeは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してHyperCodeで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、HyperCodeで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "hypercode.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するHyperCodeサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "HyperCodeを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のHyperCodeを確認中...",
  "wsl.onboarding.updatingOpencode": "HyperCodeを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のHyperCodeを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のHyperCodeを更新してください。",
  "wsl.onboarding.updateOpencode": "HyperCodeを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のHyperCodeの準備ができました。",
  "wsl.onboarding.opencodeReady": "HyperCodeの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にHyperCodeをインストールしてください。",
  "wsl.onboarding.installOpencode": "HyperCodeをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "HyperCodeがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "HyperCodeでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、HyperCodeをもう一度開いてください。",
  ...
  "help.tabs.introduction": "HyperCode Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
...
"help.guide.step3.body": "Open a project menu and choose Open Vault — browse the file tree, preview notes and explore the graph view.",
  ...
  "toast.update.description": "HyperCodeの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをHyperCodeチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (hypercode.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: HyperCodeはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "HyperCodeには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でHyperCodeサーバーを実行します。",
  ...
  "settings.general.row.language.description": "HyperCodeの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのHyperCodeの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "HyperCodeがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "HyperCodeのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "HyperCode の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "HyperCode は最新バージョンです。",
