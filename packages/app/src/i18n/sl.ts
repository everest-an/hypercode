export const dict = {
  ...
  "desktop.menu.documentation": "HyperCode Dokumentacija",
  ...
  "desktop.recovery.loadFailed": "HyperCode ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno HyperCode se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "HyperCode se ne odziva",
  ...
  "desktop.wsl.error.installOpencode": "Namestitev HyperCode ni uspela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "HyperCode ni nameščen v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Posodobitev HyperCode je končana, vendar {{distro}} še vedno poroča {{installed}}; pričakovano {{expected}}",
  ...
  "dialog.provider.deepseek.note": "Izbrani modeli, vključno z Claude, GPT, Gemini in drugimi",
  "dialog.provider.deepseek.tagline": "Zanesljivi optimizirani modeli",
  ...
  "dialog.model.unpaid.freeModels.title": "Brezplačne modele ponuja HyperCode",
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v HyperCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v HyperCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v HyperCode.",
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom HyperCode se povezuje ta aplikacija.",
  ...
  "wsl.onboarding.checkingOpencode": "Preverjanje HyperCode ...",
  "wsl.onboarding.checkingOpencodeIn": "Preverjanje HyperCode v {{distro}} ...",
  "wsl.onboarding.updatingOpencode": "Posodabljanje HyperCode ...",
  "wsl.onboarding.updatingOpencodeIn": "Posodabljanje HyperCode v {{distro}} ...",
  "wsl.onboarding.updateOpencodeIn": "Posodobite HyperCode v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Posodobite HyperCode",
  "wsl.onboarding.opencodeReadyIn": "HyperCode je pripravljen v {{distro}}.",
  "wsl.onboarding.opencodeReady": "HyperCode je pripravljen.",
  "wsl.onboarding.installOpencodeIn": "Namestite HyperCode v {{distro}}.",
  "wsl.onboarding.installOpencode": "Namestite HyperCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "HyperCode ni nameščen",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko HyperCode doda strežnik WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "HyperCode ni mogel preveriti WSL na tej napravi.",
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite HyperCode.",
  ...
  "help.tabs.introduction": "HyperCode Desktop je zdaj zgrajen okoli zavihkov.",
  "help.tabs.sessions":
...
"help.guide.step3.body": "Open a project menu and choose Open Vault — browse the file tree, preview notes and explore the graph view.",
  ...
  "toast.update.description": "Nova različica HyperCode ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.page.report.prefix": "Prosimo, prijavite to napako ekipi HyperCode",
  ...
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, HyperCode še ne podpira avtentikacije MCP.',
  ...
  "sidebar.gettingStarted.line1": "HyperCode vključuje brezplačne modele, tako da lahko začnete takoj.",
  ...
  "settings.desktop.wsl.description": "Zaženite strežnik HyperCode znotraj WSL na Windows.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za HyperCode",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako HyperCode izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali HyperCode sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo HyperCode.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene HyperCode",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico HyperCode.",
