export const dict = {
  ...
  "desktop.recovery.loadFailed": "HyperCode laadimine ebaõnnestus",
  "desktop.recovery.terminated": "HyperCode aken suleti ootamatult",
  "desktop.recovery.unresponsive": "HyperCode ei vasta",
  ...
  "desktop.wsl.error.installOpencode": "HyperCode installimine ebaõnnestus",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "HyperCode pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "HyperCode värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.provider.deepseek.note": "Kureeritud mudelid, sealhulgas Claude, GPT, Gemini ja palju muud",
  "dialog.provider.deepseek.tagline": "Usaldusväärsed optimeeritud mudelid",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub HyperCode",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid HyperCode'is.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises HyperCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises HyperCode.",
  ...
  "dialog.server.description": "Lülitage, millise HyperCode serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingOpencode": "HyperCode kontrollimine...",
  "wsl.onboarding.checkingOpencodeIn": "HyperCode kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingOpencode": "HyperCode värskendamine...",
  "wsl.onboarding.updatingOpencodeIn": "HyperCode värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Värskenda HyperCode jaotises {{distro}}.",
  "wsl.onboarding.updateOpencode": "Värskenda HyperCode",
  "wsl.onboarding.opencodeReadyIn": "HyperCode on valmis {{distro}}.",
  "wsl.onboarding.opencodeReady": "HyperCode on valmis.",
  "wsl.onboarding.installOpencodeIn": "Installige HyperCode asukohta {{distro}}.",
  "wsl.onboarding.installOpencode": "Installige HyperCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "HyperCode pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui HyperCode saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "HyperCode ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti HyperCode.",
  ...
  "help.tabs.introduction": "HyperCode Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
...
"help.guide.step3.body": "Open a project menu and choose Open Vault — browse the file tree, preview notes and explore the graph view.",
  ...
  "toast.update.description": "Rakenduse HyperCode ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast HyperCode meeskonnale",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, HyperCode ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "HyperCode sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "HyperCode Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage HyperCode server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke HyperCode kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas HyperCode teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas HyperCode järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas HyperCode on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui HyperCode käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse HyperCode uusimat versiooni.",
