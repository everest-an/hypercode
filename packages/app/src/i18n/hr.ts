...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "HyperCode se nije uspio učitati",
  "Prozor aplikacije HyperCode neočekivano je zatvoren",
  "HyperCode ne reagira",
  ...
  "Instalacija aplikacije HyperCode nije uspjela",
  ...
  "HyperCode nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije HyperCode je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "dialog.provider.deepseek.note": "Odabrani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.deepseek.tagline": "Pouzdani optimizirani modeli",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi HyperCode",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u HyperCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u HyperCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u HyperCode.",
  ...
  "dialog.server.description": "Promijenite na koji se HyperCode poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingOpencodeIn": "Provjera HyperCode u {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje HyperCode...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje HyperCode u {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažurirajte HyperCode u {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažurirajte HyperCode",
  "wsl.onboarding.opencodeReadyIn": "HyperCode je spreman u {{distro}}.",
  "wsl.onboarding.opencodeReady": "HyperCode je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instalirajte HyperCode u {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalirajte HyperCode",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što HyperCode može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "HyperCode nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite HyperCode.",
  ...
  "help.tabs.introduction": "Radna površina HyperCode sada je izgrađena oko kartica.",
  "help.tabs.sessions":
...
"help.guide.step3.body": "Open a project menu and choose Open Vault — browse the file tree, preview notes and explore the graph view.",
  ...
  "toast.update.description": "Nova verzija HyperCode ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku HyperCode timu",
  ...
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, HyperCode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "HyperCode uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "HyperCode Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite HyperCode poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za HyperCode",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako HyperCode izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li HyperCode slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je HyperCode tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se HyperCode pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju HyperCode.",
