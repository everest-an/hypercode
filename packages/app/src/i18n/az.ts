export const dict = {
  ...
  "desktop.recovery.loadFailed": "HyperCode yüklənə bilmədi",
  "desktop.recovery.terminated": "HyperCode pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "HyperCode cavab vermir",
  ...
  "desktop.wsl.error.installOpencode": "HyperCode quraşdırılması uğursuz oldu",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "HyperCode {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "HyperCode yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "dialog.provider.deepseek.note": "Claude, GPT, Gemini və daha çoxu daxil olmaqla seçilmiş modellər",
  "dialog.provider.deepseek.tagline": "Etibarlı optimallaşdırılmış modellər",
  ...
  "dialog.model.unpaid.freeModels.title": "HyperCode tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və HyperCode-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və HyperCode-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və HyperCode-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu HyperCode serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingOpencode": "HyperCode yoxlanılır...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}-də HyperCode yoxlanılır...",
  "wsl.onboarding.updatingOpencode": "HyperCode yenilənir...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-də HyperCode yenilənir...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}-də HyperCode-u yeniləyin.",
  "wsl.onboarding.updateOpencode": "HyperCode-u yeniləyin",
  "wsl.onboarding.opencodeReadyIn": "HyperCode {{distro}}-də hazırdır.",
  "wsl.onboarding.opencodeReady": "HyperCode hazırdır.",
  "wsl.onboarding.installOpencodeIn": "HyperCode-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installOpencode": "HyperCode quraşdırın",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "HyperCode quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "HyperCode WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "HyperCode bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra HyperCode-u yenidən açın.",
  ...
  "help.tabs.introduction": "HyperCode Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
...
"help.guide.step3.body": "Open a project menu and choose Open Vault — browse the file tree, preview notes and explore the graph view.",
  ...
  "toast.update.description": "HyperCode-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı HyperCode komandasına",
  ...
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: HyperCode hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "HyperCode-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində HyperCode serverini işlət.",
  ...
  "settings.general.row.language.description": "HyperCode üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "HyperCode-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "HyperCode-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "HyperCode-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "HyperCode açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "HyperCode-un ən son versiyasından istifadə edirsiniz.",
