export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'HyperCode",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'HyperCode",
  "desktop.recovery.terminated": "La fenêtre HyperCode s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "HyperCode ne répond pas",
  ...
  "desktop.wsl.error.installOpencode": "Échec de l'installation d'HyperCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "HyperCode n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'HyperCode est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.provider.deepseek.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.deepseek.tagline": "Modèles optimisés et fiables",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par HyperCode",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans HyperCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans HyperCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans HyperCode.",
  ...
  "dialog.server.description": "Changez le serveur HyperCode auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'HyperCode...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'HyperCode dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'HyperCode...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'HyperCode dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour HyperCode dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour HyperCode",
  "wsl.onboarding.opencodeReadyIn": "HyperCode est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "HyperCode est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez HyperCode dans {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "HyperCode non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'HyperCode puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "HyperCode n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez HyperCode.",
  ...
  "help.tabs.introduction": "HyperCode Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
...
"help.guide.step3.body": "Open a project menu and choose Open Vault — browse the file tree, preview notes and explore the graph view.",
  ...
  "toast.update.description":
    "Une nouvelle version d'HyperCode ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe HyperCode",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'HyperCode ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "HyperCode inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur HyperCode dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour HyperCode",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'HyperCode sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si HyperCode suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'HyperCode.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'HyperCode",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'HyperCode.",
