...
export const dict = {
  ...
  "desktop.menu.documentation": "HyperCode-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "HyperCode-meny",
  ...
  "desktop.recovery.loadFailed": "HyperCode kunne ikke lastes inn",
  "desktop.recovery.terminated": "HyperCode-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "HyperCode svarer ikke",
  ...
  "desktop.wsl.error.installOpencode": "Installasjonen av HyperCode mislyktes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "HyperCode er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av HyperCode er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.provider.deepseek.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.deepseek.tagline": "Pålitelige, optimaliserte modeller",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av HyperCode",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i HyperCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "HyperCode gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i HyperCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i HyperCode.",
  ...
  "dialog.plugins.empty": "Programtillegg konfigurert i hypercode.json",
  ...
  "dialog.server.description": "Bytt hvilken HyperCode-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av HyperCode ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til HyperCode-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (hypercode.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at HyperCode ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "HyperCode inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør HyperCode-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for HyperCode",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan HyperCode ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om HyperCode skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i HyperCode.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når HyperCode starter",
  ...
  "settings.updates.toast.latest.title": "HyperCode er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av HyperCode.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker HyperCode...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker HyperCode i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer HyperCode...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer HyperCode i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater HyperCode i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater HyperCode",
  "wsl.onboarding.opencodeReadyIn": "HyperCode er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "HyperCode er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer HyperCode i {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer HyperCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "HyperCode er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før HyperCode kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "HyperCode kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter HyperCode på nytt.",
  ...
  "help.tabs.introduction": "HyperCode Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
