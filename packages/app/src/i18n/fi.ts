export const dict = {
  ...
  "dialog.provider.deepseek.note": "Kuratoituja malleja, kuten Claude, GPT, Gemini ja muita",
  "dialog.provider.deepseek.tagline": "Luotettavat optimoidut mallit",
  ...
  "dialog.model.unpaid.freeModels.title": "HyperCoden tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja HyperCodessa.",
  ...
  "provider.connect.opencodeZen.line1":
    "HyperCode antaa sinulle pääsyn kuratoituun joukkoon luotettavia optimoituja malleja koodausagenteille.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja HyperCodessa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja HyperCodessa.",
  ...
  "dialog.plugins.empty": "Laajennukset määritetään hypercode.json-tiedostossa",
  ...
  "dialog.server.description": "Vaihda HyperCode-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingOpencode": "Tarkistetaan HyperCodea...",
  "wsl.onboarding.checkingOpencodeIn": "Tarkistetaan HyperCodea kohteessa {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Päivitetään HyperCodea...",
  "wsl.onboarding.updatingOpencodeIn": "Päivitetään HyperCodea kohteessa {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Päivitä HyperCode jakelussa {{distro}}.",
  "wsl.onboarding.updateOpencode": "Päivitä HyperCode",
  "wsl.onboarding.opencodeReadyIn": "HyperCode on valmis jakelussa {{distro}}.",
  "wsl.onboarding.opencodeReady": "HyperCode on valmis.",
  "wsl.onboarding.installOpencodeIn": "Asenna HyperCode jakeluun {{distro}}.",
  "wsl.onboarding.installOpencode": "Asenna HyperCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "HyperCodea ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin HyperCode voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "HyperCode ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten HyperCode uudelleen.",
  ...
  "toast.update.description": "HyperCoden uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä HyperCode-tiimille",
  ...
  "error.chain.checkConfig": "Tarkista määritysten (hypercode.json) palveluntarjoajien ja mallien nimet",
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että HyperCode ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "HyperCode sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita HyperCode-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda HyperCoden näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä HyperCode näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö HyperCode järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta HyperCoden teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun HyperCode käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät HyperCoden uusinta versiota.",
  ...
  "desktop.menu.documentation": "HyperCode-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "HyperCode-valikko",
  ...
  "desktop.recovery.loadFailed": "HyperCoden lataaminen epäonnistui",
  "desktop.recovery.terminated": "HyperCode-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "HyperCode ei vastaa",
  ...
  "desktop.wsl.error.installOpencode": "HyperCoden asennus epäonnistui",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "HyperCodea ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "HyperCoden päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "HyperCode Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
