...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "HyperCode 加载失败",
  "desktop.recovery.terminated": "HyperCode 窗口意外终止",
  "desktop.recovery.unresponsive": "HyperCode 未响应",
  ...
  "desktop.wsl.error.installOpencode": "HyperCode 安装失败",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} 中未安装 HyperCode",
  "desktop.wsl.error.updateVersion":
    "HyperCode 更新已完成，但 {{distro}} 仍报告版本 {{installed}}；预期版本为 {{expected}}",
  ...
  "dialog.provider.deepseek.note": "精选模型，包括 Claude、GPT、Gemini 等",
  "dialog.provider.deepseek.tagline": "可靠的优化模型",
  ...
  "dialog.model.unpaid.freeModels.title": "HyperCode 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接账户，并在 HyperCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.opencodeZen.line1": "HyperCode 为你提供一组精选的可靠优化模型，用于代码智能体。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的账户并在 HyperCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的账户并在 HyperCode 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 hypercode.json 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的 HyperCode 服务器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在检查 HyperCode...",
  "wsl.onboarding.checkingOpencodeIn": "正在检查 {{distro}} 中的 HyperCode...",
  "wsl.onboarding.updatingOpencode": "正在更新 HyperCode...",
  "wsl.onboarding.updatingOpencodeIn": "正在更新 {{distro}} 中的 HyperCode...",
  "wsl.onboarding.updateOpencodeIn": "更新 {{distro}} 中的 HyperCode。",
  "wsl.onboarding.updateOpencode": "更新 HyperCode",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 HyperCode 已就绪。",
  "wsl.onboarding.opencodeReady": "HyperCode 已就绪。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安装 HyperCode。",
  "wsl.onboarding.installOpencode": "安装 HyperCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安装 HyperCode",
  ...
  "wsl.onboarding.wslNotInstalled.description": "HyperCode 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "HyperCode 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 HyperCode。",
  ...
  "help.tabs.introduction": "HyperCode Desktop 现已采用以标签页为核心的设计。",
  "help.tabs.sessions":
...
"help.guide.step3.body": "打开项目菜单,选择 Open Vault——浏览文件树、预览笔记并查看图谱视图。",
  ...
  "toast.update.description": "HyperCode 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 HyperCode 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (hypercode.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意：HyperCode 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "HyperCode 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 HyperCode 服务器。",
  ...
  "settings.general.section.license": "许可证",
  "settings.license.status.active": "HyperCode Pro 已激活",
  "settings.license.status.active.detail": "套餐：{{plan}}",
  "settings.license.status.trial": "试用期 · 剩余 {{days}} 天",
  "settings.license.status.trial.zero": "试用已结束",
  "settings.license.status.expired": "试用已过期——订阅以继续",
  "settings.license.status.unreachable": "许可证检查不可用——按试用处理",
  "settings.license.status.unconfigured": "许可证服务未配置——按试用处理",
  "settings.license.status.unlicensed": "尚无许可证",
  "settings.license.activate.placeholder": "HC-XXXX-XXXX-XXXX-XXXX",
  "settings.license.activate.label": "许可证密钥",
  "settings.license.activate.button": "激活",
  "settings.license.activate.success": "许可证已激活",
  "settings.license.activate.error": "该密钥无法激活——请检查后重试",
  "settings.license.manage": "获取 HyperCode Pro",
  "settings.license.remove": "移除许可证",
  "settings.general.row.language.title": "语言",
  "settings.general.row.language.description": "更改 HyperCode 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 HyperCode 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 HyperCode 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 HyperCode 的主题。",
  ...
  "settings.updates.row.startup.description": "在 HyperCode 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 HyperCode。",
