export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi HyperCode",
  ...
  "desktop.menu.ariaLabel": "Menu HyperCode",
  ...
  "desktop.recovery.loadFailed": "HyperCode gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap HyperCode ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "HyperCode tidak memberi respons",
  ...
  "desktop.wsl.error.installOpencode": "Pemasangan HyperCode gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "HyperCode tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini HyperCode selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.provider.deepseek.note": "Model terpilih termasuk Claude, GPT, Gemini dan banyak lagi",
  "dialog.provider.deepseek.tagline": "Model dioptimumkan yang boleh dipercayai",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh HyperCode",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam HyperCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "HyperCode memberi anda akses kepada set model terpilih yang boleh dipercayai dan dioptimumkan untuk ejen pengekodan.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam HyperCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam HyperCode.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi dalam hypercode.json",
  ...
  "dialog.server.description": "Tukar pelayan HyperCode yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Sedang menyemak HyperCode...",
  "wsl.onboarding.checkingOpencodeIn": "Sedang menyemak HyperCode dalam {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Sedang mengemas kini HyperCode...",
  "wsl.onboarding.updatingOpencodeIn": "Sedang mengemas kini HyperCode dalam {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Kemas kini HyperCode dalam {{distro}}.",
  "wsl.onboarding.updateOpencode": "Kemas kini HyperCode",
  "wsl.onboarding.opencodeReadyIn": "HyperCode sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.opencodeReady": "HyperCode sedia digunakan.",
  "wsl.onboarding.installOpencodeIn": "Pasang HyperCode dalam {{distro}}.",
  "wsl.onboarding.installOpencode": "Pasang HyperCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "HyperCode belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum HyperCode boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "HyperCode tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula HyperCode.",
  ...
  "help.tabs.introduction": "HyperCode Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
...
"help.guide.step3.body": "Open a project menu and choose Open Vault — browse the file tree, preview notes and explore the graph view.",
  ...
  "toast.update.description": "Versi baharu HyperCode ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan HyperCode",
  ...
  "error.chain.checkConfig": "Semak konfigurasi anda (hypercode.json) nama penyedia/model",
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, HyperCode belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "HyperCode merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan HyperCode dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk HyperCode",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa HyperCode pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada HyperCode mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema HyperCode.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila HyperCode dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini HyperCode.",
