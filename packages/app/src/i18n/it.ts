export const dict = {
  ...
  "dialog.provider.deepseek.note": "Modelli selezionati tra cui Claude, GPT, Gemini e altri",
  "dialog.provider.deepseek.tagline": "Modelli affidabili e ottimizzati",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da HyperCode",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in HyperCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in HyperCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in HyperCode.",
  ...
  "dialog.server.description": "Cambia il server HyperCode a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingOpencode": "Controllo HyperCode...",
  "wsl.onboarding.checkingOpencodeIn": "Controllo HyperCode in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aggiornamento HyperCode...",
  "wsl.onboarding.updatingOpencodeIn": "Aggiornamento HyperCode in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aggiorna HyperCode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aggiorna HyperCode",
  "wsl.onboarding.opencodeReadyIn": "HyperCode è pronto in {{distro}}.",
  "wsl.onboarding.opencodeReady": "HyperCode è pronto.",
  "wsl.onboarding.installOpencodeIn": "Installa HyperCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installa HyperCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "HyperCode non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che HyperCode possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "HyperCode non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri HyperCode.",
  ...
  "help.tabs.introduction": "HyperCode Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
...
"help.guide.step3.body": "Open a project menu and choose Open Vault — browse the file tree, preview notes and explore the graph view.",
  ...
  "toast.update.description": "Una nuova versione di HyperCode ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team HyperCode",
  ...
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: HyperCode non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "HyperCode include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server HyperCode all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per HyperCode",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di HyperCode sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se HyperCode segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di HyperCode.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di HyperCode",
  ...
  "settings.updates.toast.latest.title": "HyperCode è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di HyperCode.",
  ...
  "desktop.menu.documentation": "Documentazione di HyperCode",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare HyperCode",
  "desktop.recovery.terminated": "La finestra di HyperCode si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "HyperCode non risponde",
  ...
  "desktop.wsl.error.installOpencode": "Installazione di HyperCode non riuscita",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "HyperCode non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di HyperCode è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
