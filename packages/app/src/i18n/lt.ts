...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "HyperCode įkelti nepavyko",
  "HyperCode langas netikėtai užsidarė",
  "HyperCode neatsako",
  ...
  "HyperCode įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "opencode šiame distributyve neįdiegtas",
  "opencode įdiegtas, bet jo paleisti nepavyko",
  "HyperCode neįdiegtas distributyve {{distro}}",
  "HyperCode naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "dialog.provider.deepseek.note": "Kuruojami modeliai, įskaitant Claude, GPT, Gemini ir kt.",
  "dialog.provider.deepseek.tagline": "Patikimi optimizuoti modeliai",
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami HyperCode modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje HyperCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "HyperCode suteikia prieigą prie kuruojamo patikimų optimizuotų kodavimo agentų modelių rinkinio.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius HyperCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius HyperCode.",
  ...
  "dialog.plugins.empty": "Papildiniai sukonfigūruoti hypercode.json",
  ...
  "dialog.server.description": "Perjunkite, prie kurio HyperCode serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingOpencode": "Tikrinama HyperCode...",
  "wsl.onboarding.checkingOpencodeIn": "Tikrinama HyperCode {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atnaujinamas HyperCode...",
  "wsl.onboarding.updatingOpencodeIn": "Atnaujinamas HyperCode {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atnaujinkite HyperCode {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atnaujinkite HyperCode",
  "wsl.onboarding.opencodeReadyIn": "HyperCode yra paruoštas {{distro}}.",
  "wsl.onboarding.opencodeReady": "HyperCode yra paruoštas.",
  "wsl.onboarding.installOpencodeIn": "Įdiekite HyperCode į {{distro}}.",
  "wsl.onboarding.installOpencode": "Įdiekite HyperCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "HyperCode neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad HyperCode galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "HyperCode nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite HyperCode.",
  ...
  "help.tabs.introduction": "HyperCode Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
...
"help.guide.step3.body": "Open a project menu and choose Open Vault — browse the file tree, preview notes and explore the graph view.",
  ...
  "toast.update.description": "Dabar galima įdiegti naują HyperCode ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą HyperCode komandai",
  ...
  "error.chain.checkConfig": "Patikrinkite konfigūracijos (hypercode.json) teikėjo / modelio pavadinimus",
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad HyperCode dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "HyperCode apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "HyperCode darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite HyperCode serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite HyperCode ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip HyperCode atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar HyperCode seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite HyperCode temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas HyperCode",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią HyperCode versiją.",
