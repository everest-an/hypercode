export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za HyperCode",
  ...
  "desktop.menu.ariaLabel": "HyperCode meni",
  ...
  "desktop.recovery.loadFailed": "HyperCode se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor HyperCode-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "HyperCode ne reaguje",
  ...
  "desktop.wsl.error.installOpencode": "Instalacija HyperCode-a nije uspjela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "HyperCode nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje HyperCode-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.provider.deepseek.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.deepseek.tagline": "Pouzdani optimizovani modeli",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje HyperCode",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u HyperCode-u.",
  ...
  "provider.connect.opencodeZen.line1":
    "HyperCode ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u HyperCode-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u HyperCode-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u hypercode.json",
  ...
  "dialog.server.description": "Promijeni na koji se HyperCode server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera HyperCode...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera HyperCode u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje HyperCode...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje HyperCode u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj HyperCode u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj HyperCode",
  "wsl.onboarding.opencodeReadyIn": "HyperCode je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "HyperCode je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj HyperCode u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj HyperCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "HyperCode nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi HyperCode mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "HyperCode nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori HyperCode.",
  ...
  "help.tabs.introduction": "HyperCode Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
...
"help.guide.step3.body": "Open a project menu and choose Open Vault — browse the file tree, preview notes and explore the graph view.",
  ...
  "toast.update.description": "Nova verzija HyperCode-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku HyperCode timu",
  ...
  "error.chain.checkConfig": "Provjeri nazive provajdera/modela u konfiguraciji (hypercode.json)",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: HyperCode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "HyperCode uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni HyperCode server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u HyperCode-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako HyperCode izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li HyperCode prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu HyperCode-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se HyperCode pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju HyperCode-a.",
