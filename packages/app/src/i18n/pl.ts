export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja HyperCode",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać HyperCode",
  "desktop.recovery.terminated": "Okno HyperCode zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "HyperCode nie odpowiada",
  ...
  "desktop.wsl.error.installOpencode": "Nie udało się zainstalować HyperCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "HyperCode nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja HyperCode została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.provider.deepseek.note": "Starannie dobrane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.deepseek.tagline": "Niezawodne, zoptymalizowane modele",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez HyperCode",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w HyperCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w HyperCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w HyperCode.",
  ...
  "dialog.server.description": "Przełącz serwer HyperCode, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie HyperCode...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie HyperCode w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie HyperCode...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie HyperCode w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj HyperCode w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj HyperCode",
  "wsl.onboarding.opencodeReadyIn": "HyperCode jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "HyperCode jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj HyperCode w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj HyperCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "HyperCode nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim HyperCode będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "HyperCode nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz HyperCode.",
  ...
  "help.tabs.introduction": "HyperCode Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
...
"help.guide.step3.body": "Open a project menu and choose Open Vault — browse the file tree, preview notes and explore the graph view.",
  ...
  "toast.update.description": "Nowa wersja HyperCode ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu HyperCode",
  ...
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: HyperCode nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "HyperCode zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer HyperCode wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla HyperCode",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd HyperCode na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy HyperCode ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw HyperCode.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania HyperCode",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji HyperCode.",
