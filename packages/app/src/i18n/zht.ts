...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "HyperCode 載入失敗",
  "desktop.recovery.terminated": "HyperCode 視窗意外終止",
  "desktop.recovery.unresponsive": "HyperCode 沒有回應",
  ...
  "desktop.wsl.error.installOpencode": "HyperCode 安裝失敗",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} 中未安裝 HyperCode",
  "desktop.wsl.error.updateVersion":
    "HyperCode 更新完成，但 {{distro}} 回報的版本仍為 {{installed}}；預期版本為 {{expected}}",
  ...
  "dialog.provider.deepseek.note": "精選模型，包含 Claude、GPT、Gemini 等等",
  "dialog.provider.deepseek.tagline": "經過最佳化的可靠模型",
  ...
  "dialog.model.unpaid.freeModels.title": "HyperCode 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 HyperCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.opencodeZen.line1": "HyperCode 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 HyperCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 HyperCode 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 hypercode.json 中設定的外掛程式",
  ...
  "dialog.server.description": "切換此應用程式連線的 HyperCode 伺服器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在檢查 HyperCode...",
  "wsl.onboarding.checkingOpencodeIn": "正在檢查 {{distro}} 中的 HyperCode...",
  ...
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 HyperCode 已就緒。",
  "wsl.onboarding.opencodeReady": "HyperCode 已就緒。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安裝 HyperCode。",
  "wsl.onboarding.installOpencode": "安裝 HyperCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安裝 HyperCode",
  ...
  "wsl.onboarding.wslUnavailable.description": "HyperCode 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 HyperCode。",
  ...
  "help.tabs.introduction": "HyperCode Desktop 現在以分頁為核心。",
  "help.tabs.sessions":
...
"help.guide.step3.body": "Open a project menu and choose Open Vault — browse the file tree, preview notes and explore the graph view.",
  ...
  "dialog.usageExceeded.freeTier.title": "免費額度已用完",
  "dialog.usageExceeded.freeTier.description": "目前提供商的免費額度已耗盡。請充值或升級方案,或切換到其他模型繼續使用。",
  "dialog.usageExceeded.freeTier.actionLabel": "了解更多",
  "dialog.usageExceeded.accountRateLimit.title": "用量已達上限",
  "dialog.usageExceeded.accountRateLimit.description": "提供商的用量已達上限。請在提供商後台開啟餘額用量,或設定自己的 API Key。",
  ...
  "toast.update.description": "HyperCode 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 HyperCode 團隊",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (hypercode.json) 中的 provider/model 名稱",
  "error.chain.mcpFailed": "MCP 伺服器「{{name}}」啟動失敗。注意：HyperCode 尚不支援 MCP 驗證。",
  ...
  "sidebar.gettingStarted.line1": "HyperCode 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 HyperCode 伺服器。",
  ...
  "settings.general.row.language.description": "變更 HyperCode 的顯示語言",
  ...
  "settings.general.row.appearance.description": "自訂 HyperCode 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 HyperCode 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 HyperCode 的主題。",
  ...
  "settings.updates.row.startup.description": "在 HyperCode 啟動時自動檢查更新",
