...
export const dict = {
  ...
  "dialog.provider.deepseek.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.deepseek.tagline": "Zuverlässige, optimierte Modelle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von HyperCode",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in HyperCode zu nutzen.",
  ...
  "provider.connect.opencodeZen.line1":
    "HyperCode bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in HyperCode zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in HyperCode zu nutzen.",
  ...
  "dialog.plugins.empty": "In hypercode.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den HyperCode-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingOpencode": "HyperCode wird geprüft…",
  "wsl.onboarding.checkingOpencodeIn": "HyperCode in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingOpencode": "HyperCode wird aktualisiert…",
  "wsl.onboarding.updatingOpencodeIn": "HyperCode in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie HyperCode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "HyperCode aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "HyperCode ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "HyperCode ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie HyperCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "HyperCode installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "HyperCode nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor HyperCode einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "HyperCode konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann HyperCode erneut.",
  ...
  "toast.update.description": "Eine neue Version von HyperCode ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem HyperCode-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie die Anbieter- und Modellnamen in Ihrer Konfiguration (hypercode.json)",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: HyperCode unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "HyperCode mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "HyperCode enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "HyperCode-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für HyperCode ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie HyperCode auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob HyperCode dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von HyperCode anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von HyperCode automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "HyperCode ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von HyperCode wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "HyperCode konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das HyperCode-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "HyperCode reagiert nicht",
  ...
  "desktop.wsl.error.installOpencode": "HyperCode-Installation fehlgeschlagen",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "HyperCode ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das HyperCode-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "HyperCode Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
