export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do HyperCode",
  ...
  "desktop.menu.ariaLabel": "Menu do HyperCode",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o HyperCode",
  "desktop.recovery.terminated": "A janela do HyperCode foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O HyperCode não está respondendo",
  ...
  "desktop.wsl.error.installOpencode": "Falha na instalação do HyperCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "O HyperCode não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do HyperCode foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.provider.deepseek.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.deepseek.tagline": "Modelos otimizados e confiáveis",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo HyperCode",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no HyperCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "HyperCode oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no HyperCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no HyperCode.",
  ...
  "dialog.plugins.empty": "Plugins configurados em hypercode.json",
  ...
  "dialog.server.description": "Trocar para qual servidor HyperCode este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o HyperCode...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o HyperCode em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o HyperCode...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o HyperCode em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o HyperCode em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o HyperCode",
  "wsl.onboarding.opencodeReadyIn": "O HyperCode está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O HyperCode está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o HyperCode em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o HyperCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "HyperCode não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o HyperCode possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O HyperCode não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o HyperCode novamente.",
  ...
  "help.tabs.introduction": "Agora, o HyperCode Desktop é organizado em abas.",
  "help.tabs.sessions":
...
"help.guide.step3.body": "Open a project menu and choose Open Vault — browse the file tree, preview notes and explore the graph view.",
  ...
  "toast.update.description": "Uma nova versão do HyperCode ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do HyperCode",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (hypercode.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: HyperCode ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "HyperCode inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor HyperCode dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do HyperCode",
  ...
  "settings.general.row.appearance.description": "Personalize como o HyperCode aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o HyperCode segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o HyperCode é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o HyperCode iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do HyperCode.",
