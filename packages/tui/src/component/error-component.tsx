...
export function ErrorComponent(props: { error: Error; reset: () => void; mode?: "dark" | "light" }) {
  ...
  // Safe fallback palette per mode (mirrors theme/assets/hypercode.json) since the
...
function buildIssueURL(message: string, stack: string) {
  ...
  const url = new URL("https://github.com/everest-an/hypercode/issues/new?template=bug-report.yml")
  ...
  url.searchParams.set(
    "reproduce",
    "Reported automatically from the HyperCode crash screen. If you can, describe what you were doing when it crashed.",
  )
  ...
  const marker = "\n... (truncated)"
  const head = `The HyperCode TUI crashed with an unexpected error.\n\n**Error:** ${message}\n\n**Stack trace:**\n`
